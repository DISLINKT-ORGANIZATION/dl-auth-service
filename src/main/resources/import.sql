...
insert into users (id, email, username, password, first_name, last_name, birth_date, gender) values (nextval('person_seq'), 'user@gmail.com', 'user', '$2y$12$NFN7DJUX1lFfaDX1tc9/6uBtgls9SZOU9iwjhrlXJc0xr471vgKAK', 'first', 'last', 913507200000, 1);

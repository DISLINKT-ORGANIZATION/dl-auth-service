...
import dislinkt.authservice.security.auth.RestAuthenticationEntryPoint;
import dislinkt.authservice.security.auth.TokenAuthenticationFilter;
...
//				.cors().configurationSource(request -> config).and()
    ...
    public void configure(WebSecurity web) throws Exception {
        ...
        web.ignoring().antMatchers(HttpMethod.POST, "/authentication/login", "/authentication/register", "/authentication/users/ids", "/authentication/users/*");
